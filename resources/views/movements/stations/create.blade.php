            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                        <h5>Registrar nueva estación</h5>
                    </div>
                    <div class="widget-content">
                        ...
                        <form action="/stations" method="post" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="Dirección exacta" name="address" value="{{ old('address') }}">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="Teléfono principal" name="phone" value="{{ old('phone') }}">
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span11" name="description" id="description"
                                          placeholder="¿Quién está a cargo? ¿Qué observaciones se debe tener en cuenta respecto a este punto?">{{ old('description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="lng"
                                           placeholder="Longitud del lugar" value="{{ old('lng') }}">
                                </div>
                            </div>
