...
@section('content')
    <div id="content-header">
        ...
        <h1>Modificar viaje seleccionado</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                        <h5>Modificar datos del viaje</h5>
                    </div>
                    <div class="widget-content">
                        ...
                        <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="controls">
                                    <select name="route_id" title="Seleccione una ruta">
                                        ...
                                        @foreach ($routes as $route)
                                            <option value="{{ $route->id }}" @if($route->id==old('route_id', $travel->route_id)) selected @endif>{{ $route->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="time" class="span11" placeholder="Hora de salida" name="departure_time" value="{{ old('departure_time', $travel->departure_time) }}">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="date" class="span11" placeholder="Fecha de salida"
                                           name="departure_date" value="{{ old('departure_date', $travel->departure_date) }}">
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <select name="user_id" title="Seleccione una ruta">
                                        ...
                                        @foreach ($drivers as $driver)
                                            <option value="{{ $driver->id }}" @if($driver->id==old('driver_id', $travel->user_id)) selected @endif>{{ $driver->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
